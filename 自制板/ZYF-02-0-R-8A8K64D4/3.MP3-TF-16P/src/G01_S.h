...
/** RF24L01硬件接口定义 */
/** hanwei **/
#define	RF24L01_CE						P_G01_S_CE
#define	RF24L01_IRQ						P_G01_S_IRQ

/*#define RF24L01_CS						SPI_NSS

#define RF24L01_CE_PIN_BIT				2
#define RF24L01_IRQ_PIN_BIT				4*/

/*#define RF24L01_CE_PxM0					P1M0
#define RF24L01_CE_PxM1					P1M1
#define RF24L01_IRQ_PxM0				P1M0
#define RF24L01_IRQ_PxM1				P1M1*/

/** 口线操作函数定义 */
#define RF24L01_SET_CSN_HIGH()			spi_set_nss_high()
#define RF24L01_SET_CSN_LOW()				spi_set_nss_low()
#define RF24L01_SET_CE_HIGH( )			RF24L01_CE = 1
#define RF24L01_SET_CE_LOW( )				RF24L01_CE = 0
#define RF24L01_GET_IRQ_STATUS()		((1 != RF24L01_IRQ) ? 0 : 1)
...
void NRF24L01_GPIO_config(); // for STC8A8K64D4
