...
xdata u8 g_timer_step_t1 = 0;

xdata u16 g_timer_vs_t1[CNT_SERVOS];
xdata u16 g_timer_vs_target_t1[CNT_SERVOS];
xdata u8 g_degree_t1[CNT_SERVOS];
xdata u16 g_remain_timer_t1 = 0;
...
void Servo_T1_Timer_Callback() {
	xdata u16 timer_vs = g_timer_vs_t1[g_timer_step_t1];
