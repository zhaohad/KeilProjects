...
#define RF24L01_IRQ_GPIO_PIN			GPIO_Pin_0

#define RF24L01_CS_GPIO_PORT			SPI_NSS_GPIO_PORT			//PB4
#define RF24L01_CS_GPIO_PIN				SPI_NSS_GPIO_PIN

/** 口线操作函数定义 */
#define RF24L01_SET_CE_HIGH( )			GPIO_SetBits( RF24L01_CE_GPIO_PORT, RF24L01_CE_GPIO_PIN )
#define RF24L01_SET_CE_LOW( )			GPIO_ResetBits( RF24L01_CE_GPIO_PORT, RF24L01_CE_GPIO_PIN )
