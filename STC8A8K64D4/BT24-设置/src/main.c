...
xdata u8 g_received_buf[MAX_CHAR6_COL];
xdata u8 gLine = 0;
...
void main() {
	...
	while(1) {
		...
		if (COM1.B_RX_OK && COM1.RX_TimeOut-- <= 0) {
			...
			OLED_ShowString8(0, gLine, g_received_buf);
			switch(gLine) {
				case 0:
					PrintString1("AT+VERSION\r\n");
					break;
				case 1:
					PrintString1("AT+LADDR\r\n");
					break;
				case 2:
					PrintString1("AT+NAME\r\n");
					break;
					break;
				case 3:
					PrintString1("AT+BAUD\r\n");
					break;
				case 4:
					PrintString1("AT+UUID\r\n");
					break;
				case 5:
					PrintString1("AT+CHAR\r\n");
					break;
				case 6:
					PrintString1("AT+WRITE\r\n");
					break;
				case 7:
					PrintString1("AT+NAMEHW-S1\r\n");
					break;
			}
			++gLine;
		}
