...
#define RF24L01_CE_GPIO_PORT			PORTB		//输出寄存器
#define RF24L01_CE_GPIO_ODR				DDRB		//方向寄存器
#define RF24L01_CE_GPIO_PIN				PINB		//输入寄存器
#define RF24L01_CE_GPIO_BIT				PB7			//引脚在端口的位置

#define RF24L01_IRQ_GPIO_PORT			PORTB		
#define RF24L01_IRQ_GPIO_ODR			DDRB		
#define RF24L01_IRQ_GPIO_PIN			PINB		
#define RF24L01_IRQ_GPIO_BIT			PB6			

#define RF24L01_CS_GPIO_PORT			SPI_NSS_GPIO_PORT		
#define RF24L01_CS_GPIO_ODR				SPI_NSS_GPIO_ODR		
#define RF24L01_CS_GPIO_PIN				SPI_NSS_GPIO_PIN		
#define RF24L01_CS_GPIO_BIT				SPI_NSS_GPIO_BIT	


/** 口线操作函数定义 */
#define RF24L01_SET_CE_HIGH( )			RF24L01_CE_GPIO_PORT |= 0x01 << RF24L01_CE_GPIO_BIT
#define RF24L01_SET_CE_LOW( )			RF24L01_CE_GPIO_PORT &= (uint8_t)( ~( 0x01 << RF24L01_CE_GPIO_BIT ))

#define RF24L01_SET_CS_HIGH( )			spi_set_nss_high( )
#define RF24L01_SET_CS_LOW( )			spi_set_nss_low( )

#define RF24L01_GET_IRQ_STATUS( )		(( RF24L01_IRQ_GPIO_PIN & ( 0x01 << RF24L01_IRQ_GPIO_BIT)) != ( 0x01 << RF24L01_IRQ_GPIO_BIT )) ? 0 : 1	//IRQ状态
