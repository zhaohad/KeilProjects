...
void  NRF24L01_check( void )
{
	...
	while( 1 )
	{
		...
		{
			drv_uart_tx_bytes( (uint8_t *)g_ErrorString, 26 );	//检测不到设备，输出警告信息
		}
...
{	
	//引脚配置 部分51单片机不需要 
	//CE 配置为输出 IRQ配置为输入
	RF24L01_CE_PxM0 |= IO_OUT_PUT_PP_M0 << RF24L01_CE_PIN_BIT;
	RF24L01_CE_PxM1 |= IO_OUT_PUT_PP_M1 << RF24L01_CE_PIN_BIT;
	RF24L01_CE = 1;
	
	RF24L01_IRQ_PxM0 |= IO_IN_PUT_ONLY_M0 << RF24L01_IRQ_PIN_BIT;
	RF24L01_IRQ_PxM1 |= IO_IN_PUT_ONLY_M1 << RF24L01_IRQ_PIN_BIT;
