...
//	BMM_M2M_InitStructure.BMM_Rx_Buffer = BmmRxBuffer;	//接收数据存储地址
...
//	BMM_M2M_InitStructure.BMM_Tx_Buffer = (u16)&BmmTxBuffer[255];	//发送数据存储地址
//	BMM_M2M_InitStructure.BMM_Rx_Buffer = BmmRxBuffer;	//接收数据存储地址
//	BMM_M2M_InitStructure.BMM_SRC_Dir = M2M_ADDR_DEC;		//数据源地址改变方向  	M2M_ADDR_INC,M2M_ADDR_DEC
//	BMM_M2M_InitStructure.BMM_DEST_Dir = M2M_ADDR_INC;	//数据目标地址改变方向 	M2M_ADDR_INC,M2M_ADDR_DEC
