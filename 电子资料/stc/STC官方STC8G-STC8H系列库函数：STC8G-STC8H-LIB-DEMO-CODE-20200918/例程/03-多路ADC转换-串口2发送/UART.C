...
u8 UART_Configuration(u8 UARTx, COMx_InitDefine *COMx)
{
	...
	if(UARTx == UART3)
	{
		...
		COM3.RX_TimeOut = 0;
		COM3.B_RX_OK    = 0;
		for(i=0; i<COM_TX1_Lenth; i++)	TX3_Buffer[i] = 0;
		for(i=0; i<COM_RX1_Lenth; i++)	RX3_Buffer[i] = 0;
	...
	if(UARTx == UART4)
	{
		...
		COM4.RX_TimeOut = 0;
		COM4.B_RX_OK    = 0;
		for(i=0; i<COM_TX1_Lenth; i++)	TX4_Buffer[i] = 0;
		for(i=0; i<COM_RX1_Lenth; i++)	RX4_Buffer[i] = 0;
